...
if __name__ == '__main__':
    ...
    handle_coil, label_coil = make_error_boxes(ax, dataframe_B['By_coil_mean (mT)'].values, dataframe_B['Bz_coil_mean (mT)'].values,
                 xerror=np.array([dataframe_B['By_coil_std_mean (mT)'],
                         ...
                         facecolor='C1', edgecolor='None', alpha=0.2, ms = 4, markercolor = 'r', label='coil'
                         )
    handle_measured, label_measured = make_error_boxes(ax, dataframe_B['By_measured_mean (mT)'].values,
                                               ...
                                               yerror=np.array([yerr,
                                                                yerr]),
                                               facecolor='C0', edgecolor='None', alpha=0.2, ms=4, markercolor='b',
                                               label='measured'
                                               )
    # print(pc)
